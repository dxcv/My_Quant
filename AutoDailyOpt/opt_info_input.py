...
300183 buy 300 13.25        股票300183已经以13.25的价格买入了300股
002456 sale 200 15.3        股票002456已经以15.3的价格卖出了200股

2、查询命令
last  buy                   查询最后一次买入（未抵消）的价格

3、删除命令
del 300183 buy 300 13.25
...
while True:
    ...
    if len(input_split) == 4:       # 插入命令
        ...
        插入数据命令insert into history (stk_code, stk_name, amount, price, opt, input_time) values('300183, "东软载波", 300, 12.34, 'buy', '2018-09-12 12:23:22');
