...
def gen_H_Unit(stk_code, stk_name, date_str):
    ...
    """
                ...
                <body>
                    ...
                    <p> 均线及Close图: </p>
                    <img src= "cid:""" + date_str + "/" + stk_code + "/" + "stk_ave" + '"' + """  alt="ave+close"/>
    
    
                    <br /><br /><br />
                    
                    <p> MACD图: </p>
                    <img src= "cid:""" + date_str + "/" + stk_code + "/" + "stk_macd" + '"' + """  alt="macd" />
                    <br /><br /><br />
...
def addInfoToMsg(msg, html_str, date, code_list):
    ...
    for code in code_list:
        ...
        # 测试添加png类型的图片
        fp_ave = open(pic_save_dir_root + date + '/' +code + '/stk_ave.png', 'rb')
        msgImage_ave = MIMEImage(fp_ave.read())

        msgImage_ave.add_header('Content-ID', '<' + date+'/'+code+'/stk_ave' + '>')
