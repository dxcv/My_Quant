...
from General.GlobalSetting import  mpl, plt, conn_profit, conn_k, stk_profit_data_db_name, conn_growth, conn_operation, \
...
# result = get_stk_classified_Q_ratio(class_Q,code_belongto_info,'300183')
#
# end = 0
